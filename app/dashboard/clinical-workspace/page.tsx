...
export default async function ClinicalWorkspacePage() {
  await requireUser();
  const patients = await prisma.patient.findMany({ include: { dentalChartEntries: { select: { id: true } }, clinicalRecords: { orderBy: { visitDate: "desc" }, take: 1 } }, orderBy: { updatedAt: "desc" }, take: 50 });
