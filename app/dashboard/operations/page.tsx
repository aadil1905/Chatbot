...
import { AlertTriangle, FlaskConical, PackageCheck, Plus, Truck } from "lucide-react";
...
import { addInventoryItemAction, addLabCaseAction, adjustInventoryAction, updateLabCaseAction } from "./actions";
      ...
      <section className="grid gap-5 xl:grid-cols-2">
        <article className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          ...
          <form action={addInventoryItemAction} className="mt-5 grid gap-3 sm:grid-cols-2">
            ...
            <button className="h-11 rounded-xl bg-primary px-4 font-semibold text-primary-foreground sm:col-span-2">
              Save inventory item
            </button>
          </form>
        </article>
              ...
              <article key={item.id} className="flex flex-col gap-4 px-6 py-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <form action={adjustInventoryAction} className="flex items-center gap-2">
                    ...
                    <button className="h-10 rounded-xl border border-border bg-card px-4 text-sm font-semibold hover:bg-muted">
                      Adjust
                    </button>
                  </form>
